...
public class Question5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.finalquestion_layout);
        ...
        nameDisplay.setText(name + "'s Progress");

        // Set up the question and answers
        quizContent = new QuizContent(this);
        quizContent.setupQuestion(
                R.id.questionText,
                "Which of the below options are considered macronutrients? (Please select one answer)",
                new int[]{R.id.option1, R.id.option2, R.id.option3},
                new String[]{"Vitamins", "Fiber", "Carbohydrates"},
                R.id.option3
        );
        ...
        quizContent.updateProgressBar(R.id.progressBar, 5, 5);
